export default function handler(req, res) {
  ...
  const titles = [
    '📜 MOST WANTED IN THE WEST',
    '📜 POSTED BY ORDER OF THE SHERIFF',
    '📜 WANTED DEAD OR ALIVE',
    '📜 NOTORIOUS OUTLAW AT LARGE',
    '📜 THIS VARMINT MUST BE STOPPED',
    '📜 DANGER TO CATTLE AND COMMON SENSE'
  ];
  ...
  res.status(200).send(`${title}\n💰 Your bounty is $${amount} for ${crime} in ${town}, affiliated with ${gang}.\n🔥 Wanted Level: ${stars}`);
}
